...
public class VistaAgenda extends MouseAdapter implements ActionListener {
	...
	private final String txtCargar = "Cargar";
	private final String txtSalvar = "Salvar";
	...
	protected void construyeVentanaAgenda() {
		...
		menúVentana.add(itemCargar);
		menúVentana.add(itemSalvar);
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		switch(arg0.getActionCommand()) {
			...
			case txtEditar:
				...
				break;
			case txtSalvar :
				controlador.guardarFichero();
				break;
			case txtCargar : 
				controlador.recargaFichero();
				break;
		}
	} // actionPerformed
